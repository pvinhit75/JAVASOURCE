(function ($, window) {
    $.fn.peritable = function (options) {
        ...
        function getData(url, columnName, root) {

            $.ajax({
                method: "GET",
                url: url + "?number=" + settings.page + "&size=" + settings.showData,
                success: function (obj) {
                    root.attr('totalElements', obj.totalElements)
                    //console.log('Data: ' + obj.content)
                    obj.content.forEach(function (data, index) {
                        console.log(index)
                        markup = "<tr>";
        ...
        var data = getData(settings.url, settings.columnName, $root);
        console.log('Data: ' + data)

        var totalRow = settings.totalElements;
